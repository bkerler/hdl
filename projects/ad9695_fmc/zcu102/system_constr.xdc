...
set_property  -dict {PACKAGE_PIN  J27 DIFF_TERM_ADV TERM_100 DQS_BIAS TRUE} [get_ports sysref_p]        ; ## USER_SMA_MGT_CLOCK_P
set_property  -dict {PACKAGE_PIN  J28 DIFF_TERM_ADV TERM_100 DQS_BIAS TRUE} [get_ports sysref_n]        ; ## USER_SMA_MGT_CLOCK_N
